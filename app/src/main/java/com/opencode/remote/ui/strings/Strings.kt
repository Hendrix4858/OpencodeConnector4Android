...
data class AppStrings(
    ...
    val questionCustomLabel: String,
    val questionDismissed: String,
    val questionYourAnswer: String,
...
val enStrings = AppStrings(
    ...
    questionCustomLabel = "Or type a custom answer",
...
val zhStrings = AppStrings(
    ...
    questionCustomLabel = "或输入自定义回答",
    questionDismissed = "已忽略该问题",
